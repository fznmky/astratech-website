...
const translations = {
    en: {
        ...
        form_nda: "I require a Non-Disclosure Agreement (NDA) before sharing confidential files.",
        form_nda_msg: "Understood. Please submit the form. We will email our standard NDA to you immediately for signature.",
        form_submit: "Submit Request",
        form_success_msg: "Your form is submitted and our representative will get back in contact with you as soon as possible.",
    ...
    de: {
        ...
        form_nda: "Ich benötige eine Geheimhaltungsvereinbarung (NDA), bevor ich vertrauliche Dateien teile.",
        ...
        form_success_msg: "Ihre Anfrage wurde erfolgreich übermittelt. Unser Vertreter wird sich so schnell wie möglich mit Ihnen in Verbindung setzen.",
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function (e) {
            ...
            // Temporary UX state while sending
            submitButton.innerHTML = "Sending...";

            const formData = new FormData(contactForm);

            // Your custom Google Apps Script URL
            const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzZqcpWmYuPlVFmcUMWih_nHH7dzxOAGwaLPSsxmmKRTW5-jeaEGXbBHrpZaersCzOFww/exec";

            // We use mode: 'no-cors' to prevent the browser from blocking the Google redirect
            fetch(GOOGLE_SCRIPT_URL, {
                ...
                .then(() => {
                    ...
                    // Hide the NDA alert box if it was toggled on
                    if (ndaMessage) ndaMessage.classList.add('hidden');

                    // Restore the button text
                    submitButton.innerHTML = originalBtnText;

                    // Optional: Hide the success message after 8 seconds
                    setTimeout(() => {
